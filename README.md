...
<details>
  ...
  * Data de entrega para avaliação regular do projeto: `12/09/2024 23:59`.
...
> **Atenção ⚠️:** O avaliador executa os testes em um ambiente sem banco de dados, portanto, **é necessário** que os testes não dependam de um banco de dados real para serem executados. Para isso, você pode utilizar o [Sinon](https://sinonjs.org/) para criar _stubs_ ou _spies_.
